...
import authRoute from "./routes/authRoute.js"; // Import authentication routes (login/signup)
import userRoute from "./routes/userRoute.js"; // Import user-related routes (profile, settings)
...
const allowedOrigins = [process.env.FRONTEND_URL , "https://chatterbox.krishnajain.tech"]; 
...
const io = new Server(server, {
  ...
  cors: {
    origin: [allowedOrigins[0], allowedOrigins[1]],, // ✅ Allow requests from the frontend URL
